...
fun NavGraph() {
    ...
    NavHost(
        ...
        composable(Screen.Dashboard.route) {
            DashboardScreen(
                onNavigateToCalorie = { navController.navigate(Screen.CalorieManage.route) },
                onNavigateToSleep = { navController.navigate(Screen.SleepTrack.route) },
                onNavigateToArticles = { navController.navigate(Screen.HealthArticle.route) },
